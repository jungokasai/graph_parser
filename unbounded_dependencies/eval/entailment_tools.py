...
def entails(t2props_dict, t2topsub_dict, sent_h, parse_h, sent_t, parse_t, stag_h, stag_t=[], pos_h=[], pos_t=[], 
            only_deep_arg=False, add_plus=False, add_predicative = True,
            skip_unseen_words=False, dont_skip_wildcards=False, forbid_vacuous=False,
            add_structure_transform=True, fuzz_wildcards_and_contractions=True,
            debug=False, debug_subset=False,
            return_breaking_triple=False, 
            flags={}):
