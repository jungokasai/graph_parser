...
fhand = open('results/stag_embedding_drole.txt')
...
#print(get_closest(name_to_vec['t109']))
#print(get_closest(name_to_vec['t25']))
#print (name_to_vec['t57']).dot(name_to_vec['t25'])/(norm(name_to_vec['t57'])*norm(name_to_vec['t25']))
