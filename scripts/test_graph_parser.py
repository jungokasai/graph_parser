...
parser.add_argument("--no_gold",  help="compute tag accuracy", action="store_true", default=False) ## for demo
parser.add_argument("--pretrained",  help="pretrained", action="store_true", default=False)
...
def test_parser(config, best_model, data_types, no_gold, pretrained=False):
    base_dir = config['data']['base_dir'] 
    base_command = 'python graph_parser_main.py test --base_dir {}'.format(base_dir)
    if pretrained:
...
if __name__ == '__main__':
    ...
    test_parser(config_file, best_model, data_types, opts.no_gold, opts.pretrained)
